$(function () {
    ...
    $("#forgotPasswordForm").on("submit", function (e) {
        ...
        if (!email || !isValidEmail(email)) { showAlert("Please enter a valid email address.", "danger"); $("#email").trigger("focus"); return; }
        if (!securityAnswer) { showAlert("Please enter your security answer.", "danger"); $("#securityAnswer").trigger("focus"); return; }
        if (!newPassword) { showAlert("Please enter a new password.", "danger"); $("#newPassword").trigger("focus"); return; }
        if (!confirmPassword) { showAlert("Please confirm your new password.", "danger"); $("#confirmPassword").trigger("focus"); return; }
        if (newPassword !== confirmPassword) { showAlert("Passwords do not match.", "danger"); $("#newPassword").trigger("focus"); return; }
